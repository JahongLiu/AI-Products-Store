        ...
        <div className="max-w-[500px] w-full flex flex-col">
          ...
          <div className="flex gap-2 flex-col mb-4">
            ...
            <p className="text-base text-black/60">
              Enter the realm of personalized education with our AI E-Book
              Generator. Start by specifying the topic of your desired e-book,
              anything from global history to modern technology. Then, define
              your target audience — that's you! Share your current
              understanding of the subject and what you aim to learn. Feel free
              to mention other interests too. Our AI uses this information to
              customize content, weaving in references to your interests, making
              your reading experience uniquely engaging and relevant. Click
              'Generate E-book' and watch as AI curates knowledge specifically
              for you.
            </p>
          </div>
            ...
            <div className="flex flex-wrap -mx-3 mb-4">
              <div className="w-full px-3">
                ...
                <input
                  ...
                  placeholder="Asteroids, History of Rothschild Family, Quantum Computing"
                  required
                  disabled={isLoading}
                  maxLength={100}
                />
            ...
            <div className="flex flex-wrap -mx-3 mb-4">
              <div className="w-full px-3">
                ...
                <input
                  ...
                  placeholder="Age, Expertise, Interests, etc."
                  required
                  disabled={isLoading}
                  maxLength={100}
                />
